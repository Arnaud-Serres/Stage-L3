...
parent_dir = os.path.abspath(os.path.join(base, "..", "signals"))
...
# load signal
fname = os.path.join(parent_dir, "glock.wav")
signame = 'glock'
...
axs1[2].plot(np.linspace(0, t_red_max, len(sigma_red)), np.real(tmp[0,:len(sigma_red)]),
